...
COMPONENT_NAME=digits_druid_historical
APPLICATION_MAIN_CLASS=com.yahoo.digits.druid.daemon.HistoricalDaemon
...
#digits jar
CLASSPATH=${CLASSPATH}:$YINST_ROOT/conf/${YINST_VAR_basePkg}/historical
...
JVM_ARGS="-XX:MaxDirectMemorySize=${edigits_druid__historicalDirectMem}  -Xmx${edigits_druid__historicalMaxMem} ${edigits_druid__historicalJavaOpts} -Duser.timezone=UTC -Dfile.encoding=UTF-8 -Djava.io.tmpdir=$YINST_ROOT/tmp/$YINST_VAR_basePkg ${JVM_ARGS}"
