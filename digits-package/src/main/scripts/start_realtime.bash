...
COMPONENT_NAME=digits_druid_realtime
APPLICATION_MAIN_CLASS=com.yahoo.digits.druid.daemon.RealtimeDaemon
...
JVM_ARGS="-Xmx${edigits_druid__realtimeMaxMem} ${edigits_druid__realtimeJavaOpts} -Duser.timezone=UTC -Dfile.encoding=UTF-8 -Djava.io.tmpdir=$YINST_ROOT/tmp/$YINST_VAR_basePkg ${JVM_ARGS}"
