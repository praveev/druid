...
COMPONENT_NAME=digits_druid_coordinator
APPLICATION_MAIN_CLASS=com.yahoo.digits.druid.daemon.CoordinatorDaemon
...
#digits jar
CLASSPATH=${CLASSPATH}:$YINST_ROOT/conf/${YINST_VAR_basePkg}/coordinator
...
JVM_ARGS="-Xmx${edigits_druid__coordinatorMaxMem} ${edigits_druid__coordinatorJavaOpts} -Duser.timezone=UTC -Dfile.encoding=UTF-8 -Djava.io.tmpdir=$YINST_ROOT/tmp/$YINST_VAR_basePkg ${JVM_ARGS}"
